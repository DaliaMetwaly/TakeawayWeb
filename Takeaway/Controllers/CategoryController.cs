...
namespace Takeaway.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public ActionResult LoadData()
        {
            ...
            var categoryData = db.Categories.Where(a => a.IsDetete == false).ToList().Select(i => new
            {
                ...
                Edit = "<a  id='btn_Edit' class='btn default btn-xs green' href='/Category/Edit/" + i.ID + "'>تعديل</a>",
                Deleted = "<a  id='btn_Delete' align='center' class='delete btn default btn-xs green' onclick='Delete(" + i.ID + ")'  > حذف</a>"

            }).ToList();
            return Json(new { data = categoryData }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            ViewBag.RestaurantID = new SelectList(db.Restaurants.ToList(), "ID", "RestaurantName");
            return View();
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.RestaurantID = new SelectList(db.Restaurants.ToList(), "ID", "RestaurantName", category.RestaurantID);
            return View(category);
        }
