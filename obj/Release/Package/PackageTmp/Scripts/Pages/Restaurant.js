        ...
        "columns": [
             {
                ...
                { "data": "ID", "autoWidth": true, "className": "text-center", "className": "id" },
...
function fillsMMSMessageTable() {
    ...
    //filter userdata where isHidden = 0
    var TempUserData = UserData.filter(function (el) {
   ...
   // var TempUserData=UserData.
    ...
    myTable += "<tr class='heading'><th style='width: 100px; color: red; text-align: center;display:none'>محذوف</th>";
    myTable += "<tr class='heading'><th style='width: 100px; color: red; text-align: center;display:none'>كود الفرع</th>";
    ...
    for (var i = 0; i < TempUserData.length; i++) {
        myTable += "<tr><td style='width: 100px; text-align: center;display:none'>" + TempUserData[i].count + "</td>";
        myTable += "<tr><td style='width: 100px; text-align: center;display:none'>" + TempUserData[i].IsHidden + "</td>";
        myTable += "<td style='width: 100px; text-align: center;display:none;'>" + TempUserData[i].Region_id + "</td>";
        myTable += "<td style='width: 100px; text-align: center;display:none;'>" + TempUserData[i].AddressID + "</td>";
        myTable += "<td style='width: 100px; text-align: center;'>" + TempUserData[i].Region_Name + "</td>";
        myTable += "<td style='width: 100px; text-align: center;'>" + TempUserData[i].Address + "</td>";
        myTable += "<td style='width: 100px; text-align: center;'>" + TempUserData[i].MapLatitude + "</td>";
        myTable += "<td style='width: 100px; text-align: center;'>" + TempUserData[i].MapLongitude + "</td>";
        myTable += "<td style='width: 100px; text-align: center;'>" + TempUserData[i].Phone + "</td>";
        myTable += "<td style='width: 100px; text-align: center;'>" + TempUserData[i].Mobile + "</td>";
        myTable += "<td style='width: 100px; text-align: center;'><input type='button' id='btnDeleteUserData' name='btnDeleteUserData' class='removebutton btn default btn-xs black' value='حذف' onclick='DeleteUserData(" + TempUserData[i].count + ")'/></td></tr>";
    }
    myTable += "</table>";
