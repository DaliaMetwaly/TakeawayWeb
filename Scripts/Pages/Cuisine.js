var table;
function Change(ID) {
    var URL = '/Cuisine/ChangeStatus/' + ID;
...
function LoadData() {
    table = $('#myTable').DataTable({
        ...
        "columns": [
                { "data": "CuisineAr", "autoWidth": true, "className": "text-center" },
                { "data": "CuisineEn", "autoWidth": true, "className": "text-center" },
