var table;
function Change(ID) {
    var URL = '/CookingCategory/ChangeStatus/' + ID;
...
function LoadData() {
    table = $('#myTable').DataTable({
        ...
        "columns": [
                { "data": "CookingCatNameAR", "autoWidth": true, "className": "text-center" },
                { "data": "CookingCatNameEN", "autoWidth": true, "className": "text-center" },
